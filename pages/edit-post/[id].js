    ...
    return (
        <div>
            ...
            />
             <button 
            onClick={uploadImage}
            className="mb-4 bg-purple-600 text-white font-se,ibold px-8 py-2 rounded-lg">Upload Cover Image</button>{" "}
            <button 
            onClick={updateCurrentPost}
            className="mb-4 bg-blue-600 text-white font-se,ibold px-8 py-2 rounded-lg">Update Post</button>
        </div>
    )
        }
